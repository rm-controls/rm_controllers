...
#include "gpio_controllers/gpio_controllers.h"
...
bool Controller::init(hardware_interface::RobotHW* robot_hw, ros::NodeHandle& root_nh, ros::NodeHandle& controller_nh)
{
  ...
  const std::vector<std::string>& read_gpio_names = robot_hw->get<rm_control::GpioReadHandle>()->getName();
...
PLUGINLIB_EXPORT_CLASS(gpio_controllers::Controller, controller_interface::ControllerBase)
